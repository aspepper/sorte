...
SELECT N.[Numero], N.[Ordem] FROM [dbo].[Megasenas] MS JOIN [dbo].[Sorteados] N ON N.[MegaSenaId] = MS.[Id] WHERE DataConcurso = '2020-07-22 00:00:00.0000000';
...
SELECT * FROM [dbo].[MegasenaCounters] MC WHERE MC.[DataConcurso] = '2020-07-22 00:00:00.0000000' ORDER BY MC.[Quantidade] DESC;
